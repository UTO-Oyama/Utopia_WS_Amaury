...
[
	...
	["MX SW LMG (Black)", "arifle_MX_SW_Black_F", 700],
	["MX SW LMG (Khaki)", "arifle_MX_SW_khk_F", 700, "noDLC"],
...
[
	...
	["RPG-42 High-Explosive Rocket", "RPG32_HE_F", 500],
	[".45 ACP 30Rnd Tracer (Green) Mag", "30Rnd_45ACP_Mag_SMG_01_tracer_green", 30],
	
	["5.45mm 30Rnd Mag", "30Rnd_545x39_Mag_F", 40],
...
[
	...
	**/
	...
	["Flashlight", "acc_flashlight", 500, "item"],
	["IR Laser Pointer", "acc_pointer_IR", 500, "item"],
	["Yorris Sight (Zubr Revolver)", "optic_Yorris", 1000, "item"],
	["MRD Sight (4-Five Pistol)", "optic_MRD", 1000, "item"],
	["ACO SMG (Red)", "optic_aco_smg", 1000, "item"],
...
[
	...
	["Concrete Barrier (Medium)", "Land_CncBarrierMedium_F", 1250, "object"],
	["Concrete Barrier (Long)", "Land_CncBarrierMedium4_F", 2500, "object"],
	["HBarrier (1 block)", "Land_HBarrier_1_F", 3000, "object"],
	["HBarrier (3 blocks)", "Land_HBarrier_3_F", 1000, "object"],
	["HBarrier (5 blocks)", "Land_HBarrier_5_F", 1250, "object"],
	["HBarrier Big", "Land_HBarrierBig_F", 2500, "object"],
	["HBarrier Wall (4 blocks)", "Land_HBarrierWall4_F", 2000, "object"],
	["HBarrier Wall (6 blocks)", "Land_HBarrierWall6_F", 2500, "object"],
...
[
	...
	["Kart", "C_Kart_01_F", 1000, "vehicle", "SKIPSAVE"],

	["Quadbike (Civilian)", "C_Quadbike_01_F", 1200, "vehicle", "SKIPSAVE"],
	["Quadbike (NATO)", "B_Quadbike_01_F", 1300, "vehicle", "SKIPSAVE"],
	["Quadbike (CSAT)", "O_Quadbike_01_F", 1300, "vehicle", "SKIPSAVE"],
	["Quadbike (AAF)", "I_Quadbike_01_F", 1300, "vehicle", "SKIPSAVE"],
	["Quadbike (FIA)", "B_G_Quadbike_01_F", 1300, "vehicle", "SKIPSAVE"],

	["Hatchback", "C_Hatchback_01_F", 1600, "vehicle", "SKIPSAVE"],
	["Hatchback Sport", "C_Hatchback_01_sport_F", 2000, "vehicle", "SKIPSAVE"],
	["SUV", "C_SUV_01_F", 2200, "vehicle", "SKIPSAVE"],

	["MB 4WD", "C_Offroad_02_unarmed_F", 2000, "vehicle", "SKIPSAVE"],
	["MB 4WD (Guerilla)", "I_C_Offroad_02_unarmed_F", 1800, "vehicle", "SKIPSAVE"],

	["Offroad", "C_Offroad_01_F", 2200, "vehicle", "SKIPSAVE"],
	["Offroad Camo", "B_G_Offroad_01_F", 2500, "vehicle", "SKIPSAVE"],
	["Offroad Repair", "C_Offroad_01_repair_F", 3000, "vehicle", "SKIPSAVE"],
	["Offroad HMG", "B_G_Offroad_01_armed_F", 5000, "vehicle", "SKIPSAVE"],

	["Truck", "C_Van_01_transport_F", 1400, "vehicle", "SKIPSAVE"],
	["Truck (Camo)", "B_G_Van_01_transport_F", 1600, "vehicle", "SKIPSAVE"],
	["Truck Box", "C_Van_01_box_F", 1800, "vehicle", "SKIPSAVE"],
	["Fuel Truck", "C_Van_01_fuel_F", 4000, "vehicle", "SKIPSAVE"],
	["Fuel Truck (Camo)", "B_G_Van_01_fuel_F", 4200, "vehicle", "SKIPSAVE"],
	...
	["HEMTT Covered", "B_Truck_01_covered_F", 14000, "vehicle"],
	["HEMTT Fuel", "B_Truck_01_fuel_F", 16000, "vehicle"],
	["HEMTT Medical", "B_Truck_01_medical_F", 18000, "vehicle"],
	//["HEMTT Repair", "B_Truck_01_Repair_F", 10000, "vehicle"],

	["Tempest Device", "O_Truck_03_device_F", 8000, "vehicle"],
	["Tempest Resupply", "O_Truck_03_ammo_F", 1000, "vehicle"],
	["Tempest Transport", "O_Truck_03_transport_F", 12000, "vehicle"],
	["Tempest Covered", "O_Truck_03_covered_F", 14000, "vehicle"],
	["Tempest Fuel", "O_Truck_03_fuel_F", 16000, "vehicle"],
	["Tempest Medical", "O_Truck_03_medical_F", 18000, "vehicle"],
	//["Tempest Repair", "O_Truck_03_repair_F", 10000, "vehicle"],

	["Zamak Resupply", "I_Truck_02_ammo_F", 8000, "vehicle"],
	["Zamak Transport", "I_Truck_02_transport_F", 8000, "vehicle"],
	["Zamak Covered", "I_Truck_02_covered_F", 10000, "vehicle"],
	["Zamak Fuel", "I_Truck_02_fuel_F", 12000, "vehicle"],
...
[
	["Prowler (Doorless)", "B_CTRG_LSV_01_light_F", 3000, "vehicle", "SKIPSAVE"],
	["Prowler", "B_T_LSV_01_unarmed_F", 4000, "vehicle", "SKIPSAVE"],
	["Prowler HMG", "B_T_LSV_01_armed_F", 12000, "vehicle", "SKIPSAVE"],
	["Qilin", "O_T_LSV_02_unarmed_F", 4000, "vehicle", "SKIPSAVE"],
	["Qilin Minigun", "O_T_LSV_02_armed_F", 12000, "vehicle", "SKIPSAVE"],

	["Hunter", "B_MRAP_01_F", 8000, "vehicle", "SKIPSAVE"],
	["Hunter HMG", "B_MRAP_01_hmg_F", 30000, "vehicle"],
	["Hunter GMG", "B_MRAP_01_gmg_F", 30000, "vehicle"],
	["Ifrit", "O_MRAP_02_F", 8000, "vehicle", "SKIPSAVE"],
	...
	["MSE-3 Marid", "O_APC_Wheeled_02_rcws_F", 44500, "vehicle"],
	["AMV-7 Marshall", "B_APC_Wheeled_01_cannon_F", 54500, "vehicle"],
...
[
	["Bouteille d'eau", "water", localize "STR_WL_ShopDescriptions_Water", "client\icons\waterbottle.paa", 50, 15],
	["Boite de conserve", "cannedfood", localize "STR_WL_ShopDescriptions_CanFood", "client\icons\cannedfood.paa", 50, 15],
	["Kit de réparation", "repairkit", localize "STR_WL_ShopDescriptions_RepairKit", "client\icons\briefcase.paa", 3000, 250],
	["Kit de réarmement", "ammokit", "", "client\icons\briefcase.paa", 10000, 250],
	["Bidon d'essence (Rempli)", "jerrycanfull", localize "STR_WL_ShopDescriptions_fuelFull", "client\icons\jerrycan.paa", 300, 75],
	["Bidon d'essence (Vide)", "jerrycanempty", localize "STR_WL_ShopDescriptions_fuelEmpty", "client\icons\jerrycan.paa", 100, 25],
	["Balise de spawn", "spawnbeacon", localize "STR_WL_ShopDescriptions_spawnBeacon", "client\icons\spawnbeacon.paa", 7500, 750],
	["Filet de camouflage", "camonet", localize "STR_WL_ShopDescriptions_Camo", "client\icons\camonet.paa", 400, 100],
	["Syphon", "syphonhose", localize "STR_WL_ShopDescriptions_SyphonHose", "client\icons\syphonhose.paa", 400, 100],
	["Boisson énergisante", "energydrink", localize "STR_WL_ShopDescriptions_Energy_Drink", "client\icons\energydrink.paa", 1000, 50],
	["Métal", "metal", "", "client\icons\metal.paa", 1000, 50],
	["Changement de classe", "class_change", "", "\A3\ui_f\data\GUI\Cfg\Ranks\general_gs.paa", 250000, 100000],
	["Coffre fort", "warchest", localize "STR_WL_ShopDescriptions_Warchest", "client\icons\warchest.paa", 8000, 500]
];
