...
createDefenseForces = [_path, "createUnits\createDefenseForces.sqf"] call mf_compile;
...
fn_debugBoxRequest = ["server\debugBox", "fn_debugBoxRequest.sqf"] call mf_compile;
fn_debugBoxAddTicket = ["server\debugBox", "fn_debugBoxAddTicket.sqf"] call mf_compile;