...
_createRandomVehicle =
{
	...
	if(_pos isEqualTo [0,0,0]) then {
		systemChat str "ERROR";
	};

	_vehicleType =
	[
		[getArray (missionConfigFile >> "CfgVehicleSpawning" >> "vehicles" >>  "A3W_smallVehicles"), 0.30],
		[getArray (missionConfigFile >> "CfgVehicleSpawning" >> "vehicles" >>  "civilianVehicles"), 0.40],
		[getArray (missionConfigFile >> "CfgVehicleSpawning" >> "vehicles" >>  "lightMilitaryVehicles"), 0.25],
		[getArray (missionConfigFile >> "CfgVehicleSpawning" >> "vehicles" >>  "mediumMilitaryVehicles"), 0.05]
