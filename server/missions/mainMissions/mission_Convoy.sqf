...
_setupObjects =
{
	...
	_missionHintText = format ["Un <t color='%2'>%1</t> transportant une caisse d'arme a été repéré. Arretez-les !", _vehicleName, mainMissionColor];
...
_successExec =
{
	...
	[_box1, "mission_ArmedConvoy"] call fn_refillbox;

	_successHintMessage = "Le convoi a été neutralisé , les caisses d'armes sont à vous .";
};
