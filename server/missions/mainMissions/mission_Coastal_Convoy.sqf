...
_setupVars =
{
	_missionType = "Patrouille côtière";
...
_setupObjects =
{
	...
	_missionHintText = format ["Deux <t color='%3'>%1</t> patrouillent sur le bord des côtes , escortés par <t color='%3'>%2</t>.<br/>Interceptez les et récupérez leur chargement !", _vehicleName, _vehicleName2, mainMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "La patrouille a été arrêtée , les caisses d'armes sont vôtres. Vous les trouverez près des épaves !";
};
