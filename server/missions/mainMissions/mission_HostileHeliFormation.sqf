...
_setupVars =
{
	_missionType = "Patrouille d'hélicoptères";
...
_setupObjects =
{
	...
	_missionHintText = format ["Une formation d'hélicoptères composé de <t color='%3'>%1</t> et de deux <t color='%3'>%2</t> patrouille autour de l'île. Détruisez-les et récupérez leur contenu !", _vehicleName, _vehicleName2, mainMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "La patrouille d'hélicoptères	a été éliminée ! Les caisses d'armes sont tombées sur le sol.";
};
