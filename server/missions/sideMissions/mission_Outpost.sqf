...
_setupObjects =
{
	...
	_missionHintText = format ["Un <t color='%1'>outpost</t> contenant des caisses d'armes a été repéré !", sideMissionColor]
};
...
_successExec =
{
	...
	_successHintMessage = "L'outpost a été capturé , bien joué !";
};
