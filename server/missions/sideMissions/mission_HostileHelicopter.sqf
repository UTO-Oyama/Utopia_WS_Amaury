...
_setupObjects =
{
	...
	_missionHintText = format ["Un <t color='%2'>%1</t> armé est en train de patrouiller . Interceptez-le et récupérez les caisses d'arme !", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Le patrouille a été éliminée !<br/> Les caisses d'armes sont tombées au sol .";
};
