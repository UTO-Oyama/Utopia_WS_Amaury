...
private ["_nbUnits", "_wreckPos", "_wreck", "_box1"];

_setupVars =
{
	_missionType = "Crash d'avion";
...
_setupObjects =
{
	...
	[_box1, "mission_AircraftWreck"] call fn_refillbox;
	...
	_missionHintText = "Un hélicoptère a été abattu !";
};
...
{
	// Mission failed
	{ deleteVehicle _x } forEach [_box1, _wreck];
};
...
_successExec =
{
	...
	_successHintMessage = "Le contenu de l'avion a été récupéré.";
};
