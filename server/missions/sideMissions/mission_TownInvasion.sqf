...
_setupObjects =
{
	...
	_missionHintText = format ["Des rebelles ont pris <br/><t size='1.25' color='%1'>%2</t><br/><br/>Il semble y avoir <t color='%1'>%3 ennemis</t> se cachant dans les bâtiments. Eliminez-les et récupérez leur armement .<br/>Attention aux embuscades !", sideMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Bon boulot !<br/><br/><t color='%1'>%2</t><br/>est à nouveau un endroit sûr!<br/>Leurs affaires sont à vous !", sideMissionColor, _townName];
