...
_setupObjects =
{
	...
	_missionHintText = format ["Un <t color='%2'>%1</t> transportant une caisse d'armes est en route vers une destination inconnue. Arretez le convoi !", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	[_box1, "mission_Supplytruck"] call fn_refillbox;

	_successHintMessage = "Le convoi a été stoppé , les caisses d'arme sont à vous !";
};
