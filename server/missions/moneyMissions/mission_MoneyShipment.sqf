...
_setupObjects =
{
	...
	_missionHintText = format ["Un convoi transportant <t color='%1'>%2</t> escorté par un <t color='%1'>%3</t> est en route vers une destination inconnue.<br/>Arretez-les !", moneyMissionColor, _moneyText, _vehicleName];
...
_successExec =
{
	...
	_successHintMessage = "Le convoi a été stoppé , l'argent est à vous.";
};
