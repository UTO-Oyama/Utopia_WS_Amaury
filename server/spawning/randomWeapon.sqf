...
_car = _this select 0;
_additionArray = getArray (missionConfigFile >> "CfgVehicleSpawning" >> "vehicleInventory" >>  "vehicleItems");
...
_weapon = (getArray (missionConfigFile >> "CfgVehicleSpawning" >> "vehicleInventory" >>  "vehicleWeapons")) call fn_selectRandomNested;
...
_additionThree = _additionArray call fn_selectRandomNested;
