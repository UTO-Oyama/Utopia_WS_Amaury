...
//{
	...
	_spawnType = (getArray (missionConfigFile >> "CfgVehicleSpawning" >> "vehicles" >>  "staticHeliList")) call fn_selectRandomNested;
	...
	_capacity = switch (true) do { 
	case (_currHeli isKindOf "Truck") : { 15 }; 
	default { 5 }; 
};
_currHeli setVariable ["virtualItems",[[],_capacity],true];
/*}
else
{
