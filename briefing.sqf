...
[
"Utopia 1.06 (31/01/17)",
"
<br/>[added] a lot of capacities.
<br/>[added] permanent group system.
<br/>[added] controls menu , can change keys
<br/>[added] xp reward for group members.
<br/>[added] ammo kits
<br/>[added] class change item.
<br/>[added] engineer can now disassemble weapons , mines and explosives (level required)
<br/>[added] medic can hide bodies for money.
<br/>[changed] reworked the capacities and leveling menu.
<br/>[changed] chances of special mission spawning
<br/>[changed] vehicle save time (5 days now).
<br/>[changed] player menu completly reworked.
<br/>[fixed] auto reload capacity.
<br/>[fixed] bug box.
<br/>[fixed] only medics can revive
<br/>[fixed] cannot call capacity when dead.
<br/>[fixed] cannot take metal from salvaged vehicles.
"
]];

player createDiaryRecord ["changelog",
[
"Utopia v1.05 [16/12/16]",
"
<br/>[Added] New missions : Bunker
<br/>[Added] New IA groups.
<br/>[Added] Vehicle virtual items inventories
<br/>[Added] Changelog notifier
<br/>[Added] Vehicle crafting , buildings crafting.
<br/>[Added] New items , vehicle wrecks and gold(not present now).
<br/>[Added] Debug box , where you can report bugs etc ...
<br/>[Changed] Debug box ticket cooldown.
<br/>[Changed] Prices in general store.
<br/>[Changed] LANGUAGE OF MISSION NOW IN FRENCH.
<br/>[Fixed] Putting money in base normaly works for both side.
<br/>[Fixed] Saving HMG from bases disabled.
<br/>[Fixed] Some other fixes but i forgot ...
"
]];

player createDiaryRecord ["changelog",
[
"Utopia v1.04 [11/12/16]",
"
<br/>[Added] New missions : Special Forces.
<br/>[Added] New HUD.
<br/>[Added] 2 new categories of crafting.
<br/>[Added] New bases.
<br/>[Added] Loses XP when teamkill.
<br/>[Added] Coton field.
<br/>[Added] Can craft uniforms , vests  and headgears.
<br/>[Added] New items (metal plate , cotton, uniform pieces).
<br/>[Changed] IA now rewards xp based on their classes (medic = 150xp , soldier=100xp)...
<br/>[Changed] Leveling menu design.
<br/>[Changed] Can now handle 20 metal.
<br/>[Changed] Quantity of hunters spawning .
<br/>[Fixed] player create multiple crafting or leveling menus.
<br/>[Fixed] Computer hacking doesn't despawn.
<br/>[Fixed] Cannot craft magazines.
<br/>[Fixed] Putting money in base didn't work , now handled by server.
"
]];
...
player createDiaryRecord ["changelog",
[
"Utopia v1.03 [9/12/16]",
"
<br/>[Added] New missions : Metal convoy and computer hacking.
<br/>[Fixed] Animations when hacking , fixing wheels.
<br/>[Fixed] Engineer can repair mens.
<br/>[Added] New item : piles of metal , can be found in mission.
"
]];

player createDiaryRecord ["changelog",
[
"Utopia v1.02 [8/12/16]",
"
<br/>[Added] More items and categories in crafting menu.
<br/>[Added] Can buy metal in General store.
<br/>[Added] Number of metal recolted when salvaging depend on the vehicle.
"
]];

player createDiaryRecord ["changelog",
[
"Utopia v1.01 [6/12/16]",
"
<br/>[Fixed] Base spawn beacon doesn't display a hundred of times in the spawn menu.
<br/>[Fixed] Base objects are now locked and unmovable.
<br/>[Fixed] Fixed mouseWheel bug when in new Menus.
<br/>[Fixed] Now beginning at level 1 , before it was 0.
<br/>[Fixed] Engineer repairing capacity.
<br/>[Fixed] Some script optimizations.
<br/>[Fixed] Snipers kicked for hack recoil at level 2.
<br/>[Added] Notifications when you lost , earn XP.
<br/>[Added] Lost XP when killed by AI.
<br/>[Added] Class displayed with player names.
<br/>[Added] ATM menu in bases.
<br/>[Changed] Different spawn stuff for every classes.
<br/>[Changed] A repair kit now gives 3 metal.
<br/>[Changed] Spawn beacon height at 1200m.
<br/>[Changed] Can't revive when a player takes a headshot.
"
]];
