...
[MF_ITEMS_JERRYCAN_EMPTY, "Bidon d'essence vide", _refill, "Land_CanisterFuel_F", _iconJerry, _max] call mf_inventory_create;
[MF_ITEMS_JERRYCAN_FULL, "Bidon d'essence", _refuel, "Land_CanisterFuel_F", _iconJerry, _max] call mf_inventory_create;
[MF_ITEMS_SYPHON_HOSE, "Syphon", _syphon, "Land_CanisterOil_F", _iconSyphon, MF_ITEMS_SYHON_HOSE_MAX] call mf_inventory_create;
...
_label1 = format["<img image='%1'/> Remplir le bidon d'essence", _iconJerry];
...
_label2 = format["<img image='%1'/> Refuel le véhicule", _iconJerry];
...
_label3 = format["<img image='%1'/> Syphoner le véhicule", _iconSyphon];
