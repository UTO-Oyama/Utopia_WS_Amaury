...
#define ERR_NOT_ENOUGH_FUNDS "Vous n'avez pas assez d'argent sur votre compte en banque."
#define ERR_INVALID_ACCOUNT "Le véhicule délectionné est invalide."
#define ERR_MAX_BALANCE_REACHED "Le compte sélectionné est plein.\nVous ne pouvez pas lui envoyer plus d'argent."
#define ERR_MAX_BALANCE_LIMIT "Vous ne pouvez pas envoyer plus de $%1 à ce compte en banque."

#define MSG_CONFIRM_LINE1 "Vous êtes sur le point de transferer $%1 à %2."
#define MSG_CONFIRM_LINE2 "Taux de transfer: $%2"
#define MSG_CONFIRM_LINE3 "Prix total: $%1"
