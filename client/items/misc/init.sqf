...
MF_ITEMS_AMMOKIT = "ammokit";
_ammo = [_path, "ammo.sqf"] call mf_compile;
[MF_ITEMS_AMMOKIT, "Kit de munitions", _ammo , "Land_SuitCase_F","client\icons\medkit.paa",2] call mf_inventory_create;

MF_ITEMS_REPAIR_KIT = "repairkit";
_repair = [_path, "repair.sqf"] call mf_compile;
_icon = "client\icons\repair.paa";
[MF_ITEMS_REPAIR_KIT, "Kit de réparation", _repair, "Land_SuitCase_F",_icon,2] call mf_inventory_create;
...
_label1 = format["<img image='%1'/> Réparer le véhicule", _icon];
...
_label2 = format["<img image='%1'/> Réarmer le véhicule", "\A3\ui_f\data\GUI\Cfg\Hints\AmmoType_CA.paa"];
_execute2 = {MF_ITEMS_AMMOKIT call mf_inventory_use};
_condition2 = "'ammokit' call mf_inventory_count > 0 && {cursorTarget isKindOf 'LandVehicle' || cursorTarget isKindOf 'Air'} && alive cursorTarget && player distance cursorTarget < 5";
_action2 = [_label2, _execute2, [], 1, false, false, "", _condition2];
["repairkit-use", _action2] call mf_player_actions_set;
