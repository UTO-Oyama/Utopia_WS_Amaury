...
{
	[format ["Vous n'êtes pas autorisé à désassembler des armes.<br/>Use the ""%1"" option instead.", ["STR_R3F_LOG_action_deplacer_objet", "Move"] call getPublicVar]] spawn BIS_fnc_guiMessage;
};
