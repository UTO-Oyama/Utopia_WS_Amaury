...
//added by [utopia] Amaury for the crafting system
loadCraftingMenu = "client\systems\crafting\loadCraftingMenu.sqf" call mf_compile;
craft_onCategoryChanged = "client\systems\crafting\onCategoryChanged.sqf" call mf_compile;
craft_onReceipeChanged = "client\systems\crafting\onReceipeChanged.sqf" call mf_compile;
craft_onCraftClick = "client\systems\crafting\onCraftClick.sqf" call mf_compile;
craft_hasItems = "client\systems\crafting\hasItems.sqf" call mf_compile;
craft_hasCorrectClass = "client\systems\crafting\hasCorrectClass.sqf" call mf_compile;
craft_hasCorrectClassLevel = "client\systems\crafting\hasCorrectClassLevel.sqf" call mf_compile;
craft_harvest = "client\systems\crafting\harvesting\harvest.sqf" call mf_compile;
craft_tryharvest = "client\systems\crafting\harvesting\tryharvest.sqf" call mf_compile;
craft_getRequiredLevel = "client\systems\crafting\getRequiredLevel.sqf" call mf_compile;

loadKeysMenu = "client\systems\keysMenu\loadKeysMenu.sqf" call mf_compile;

loadClassChoiceMenu = "client\systems\leveling\loadClassChoiceMenu.sqf" call mf_compile;
loadLevelingManager = "client\systems\leveling\loadLevelingManager.sqf" call mf_compile;
...
lvl_classToString = "client\systems\leveling\fn_classToString.sqf" call mf_compile;
lvl_getRequiredXP = "client\systems\leveling\fn_getRequiredXP.sqf" call mf_compile;
lvl_addXP = "client\systems\leveling\mp\fn_addXp.sqf" call mf_compile;
lvl_removeXP = "client\systems\leveling\mp\fn_removeXp.sqf" call mf_compile;
lvl_haveCapacity = "client\systems\leveling\fn_haveCapacity.sqf" call mf_compile;
lvl_isDamaged = "client\systems\leveling\misc\fn_isDamaged.sqf" call mf_compile;
lvl_chooseKey = "client\systems\leveling\misc\fn_chooseKey.sqf" call mf_compile;
lvl_progressBar = "client\systems\leveling\misc\fn_progressBar.sqf" call mf_compile;
...
lvl_loadkeys = "client\systems\leveling\capacities\loadkeys.sqf" call mf_compile;
lvl_capacitiesToArray = "client\systems\leveling\fn_capacitiesToArray.sqf" call mf_compile;
lvl_keysHandle = "client\systems\leveling\capacities\handleKeys.sqf" call mf_compile;

fn_loadDebugBox = "client\systems\bugBox\fn_loadDebugBox.sqf" call mf_compile;
fn_updateDebugBox =  "client\systems\bugBox\fn_updateDebugBox.sqf" call mf_compile;
...
ug_fnc_serverMessage = "client\functions\fn_serverMessage.sqf" call mf_compile;
fn_loadBaseMenu =  "client\systems\baseMenu\fn_loadBaseMenu.sqf" call mf_compile;
fn_updateBaseMenu =  "client\systems\baseMenu\fn_updateBaseMenu.sqf" call mf_compile;
fn_loadArtilleryMenu = "client\systems\baseMenu\fn_loadArtilleryMenu.sqf" call mf_compile;
fn_getPlayerTeamStr = "client\systems\baseMenu\fn_getPlayerTeamStr.sqf" call mf_compile;
fn_updateServicesMenu = "client\systems\baseMenu\fn_updateServicesMenu.sqf" call mf_compile;
fn_loadGroupMenu = "client\systems\groupSystem\fn_loadGroupMenu.sqf" call mf_compile;
fn_createGroupMenu = "client\systems\groupSystem\fn_createGroupMenu.sqf" call mf_compile;
fn_updateGroupMenu = "client\systems\groupSystem\fn_updateGroupMenu.sqf" call mf_compile;
fn_playerAddMoney = "client\functions\fn_playerAddMoney.sqf" call mf_compile;
fn_editDialog = "client\systems\groupSystem\fn_editDialog.sqf" call mf_compile;

if (isNil "A3W_fnc_MP") then { A3W_fnc_MP = compileFinal preprocessFileLineNumbers "\A3\functions_f\MP\fn_MP.sqf" };
if (isNil "A3W_fnc_MPexec") then { A3W_fnc_MPexec = compileFinal preprocessFileLineNumbers "\A3\functions_f\MP\fn_MPexec.sqf" };

player groupChat "Wasteland - Compilation des fonctions client terminée";
sleep 1;
