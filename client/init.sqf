...
//@file Modified by [utopia] Amaury
...
[] execVM "client\systems\forbiddenZones\init.sqf";
...
call compile preprocessFileLineNumbers "client\systems\leveling\init.sqf"; // initialize vars of leveling system
call compile preprocessFileLineNumbers "client\systems\crafting\harvesting\init.sqf";
...
{
	_scriptHandle = [] spawn compile preprocessFileLineNumbers "persistence\client\players\setupPlayerDB.sqf";
	waitUntil {
