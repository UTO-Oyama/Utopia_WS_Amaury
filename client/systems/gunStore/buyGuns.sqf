...
storePurchaseHandle = _this spawn
{
	...
	_showInsufficientFundsError =
	{
		...
		hint parseText format ["Vous n'avez pas assez d'argent pour ""%1""", _itemText];
	...
	{
		_itemText = _this select 0;
		hint parseText format ["Vous n'avez pas assez de place pour <br/>""%1""", _itemText];
		playSound "FD_CP_Not_Clear_F";
		_price = -1;
	};
	...
	{
		_itemText = _this select 0;
		hint parseText format ["<t color='#ffff00'>Une erreur est survenue.</t><br/>L'achat de ""%1"" a été annulé.", _itemText];
		playSound "FD_CP_Not_Clear_F";
		_price = -1;
	};
	...
	{
		_itemText = _this select 0;
		hint format ["""%1"" a été crée dehors , en face du magasin.", _itemText];
	...
	{
		_itemText = _this select 0;
		hint format ["Votre inventaire est plein , ou vous avez déjà cette arme sur vous. Veuillez la déposer avant d'acheter ""%1""", _itemText];
		playSound "FD_CP_Not_Clear_F";
		_price = -1;
	};
